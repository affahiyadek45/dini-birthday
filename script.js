    ...
    function showBirthdayGate() {
        ...
        gate.innerHTML = `
            ...
            <div class="birthday-gate-card">
                ...
                <h2>Setelah Berpisah, Kapan pertama kali kita bertemu ?</h2>
...
/*
 * =========================================================
 * PROTEKSI INPUT TANGGAL
 * =========================================================
 *
 * Saat user mengetik di kolom tanggal,
 * tombol keyboard TIDAK BOLEH diteruskan
 * ke game Dino / Flappy.
 *
 * Termasuk tombol SPACE.
 * =========================================================
 */
...
input.addEventListener(
    ...
    event => {
        ...
        /*
         * Kalau Space ditekan,
         * biarkan browser memasukkan spasi
         * ke dalam input.
         *
         * Tapi hentikan event supaya game
         * tidak ikut menerima tombol Space.
         */
        ...
        /*
         * Tombol panah juga jangan sampai
         * menggerakkan Dino ketika sedang
         * mengetik di input.
         */
