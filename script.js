    ...
    if (startButton) {
        ...
        startButton.addEventListener(
            ...
            async () => {
                ...
                /* Intro heart explosion dipindahkan ke setelah lilin ditiup. */
                openCandleScene();

                /* Mic baru diminta setelah pengguna menekan tombol ♡. */
                startCandleMicrophone();

                /*
                 * Siapkan audio dalam keadaan mute agar browser menganggap
                 * audio sudah diinisialisasi dari gesture pengguna.
                 * Musik tetap BENAR-BENAR diam sampai lilin ditiup.
                 */
                if (music) {
                    try {
                        music.muted = true;
